...
const About = () => {
  ...
  return (
    <div className="container about-wrapper">
      <h1
        className={`about-heading about-heading-${theme === "light" ? "dark" : "light"
          }`}
      >
        Overview
      </h1>
      <div
        className={`about-data-wrapper ${theme === "light" ? "shadow-dark" : "bg-secondary"
          }`}
      >
      ...
      >
        <div className="feature-line">
          ...
          <p
            className={`${theme === "light" ? "bg-primary-light" : "bg-grey"
